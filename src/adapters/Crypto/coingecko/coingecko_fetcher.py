...
class CoingeckoFetcher(CryptoInterface):
    ...
    def return_crypto_info(self, crypto_name: str) -> dict:
        crypto_info = {"asset_name": "",
                       ...
                       "current_price": ""}
        try:
            url = f"{settings.BASE_ENDPOINT_CRYPTOFETCHER}/coins/"
            params = {
                "id": crypto_name,
                "sparkline": "true"
            }
            ...
            crypto_info["current_price"] = _raw_financial_data["market_data"]["market_cap"]["current_price"]
